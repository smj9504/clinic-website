...
/**
 * 장비 사진을 그리되, 실사진이 없으면(hasRealEquipmentImage) 임의 사진 대신
 * 클리닉 로고를 축소해 보여준다. "사진이 없으면 fallback을 보여주고, 절대
 * 관계없는 임의 사진을 보여주지 않는다"는 원칙 — 데모 시딩 단계의 Unsplash
 * 이미지도 관리자가 실사진으로 교체하기 전까지는 "사진 없음"과 동일하게
 * 취급한다. 로고는 object-cover가 아니라 contain으로 축소해 실사진처럼
 * 화면을 꽉 채우는 대신 브랜드 마크임이 분명하게 보이도록 한다.
 */
